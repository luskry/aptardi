...
Any name starting with foo is either a 1) file generated by the program and saved or 2) a folder path to perform operations. Paths can be relative to the current working directory, but when in doubt, specify absolute paths (i.e. /Users/foo_name/foo_model.hdf5)
